...
const NavBar = ({ user: propUser, setUser, onLogout }) => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log("Error fetching user profile details:", err);
      }
    };
  ...
  // To handle clicks outside the dropdown menu - closes the menu if clicked outside
            ...
            <button onClick={toggleMenu} className={navbarStyles.userButton}>
              ...
              <div className={navbarStyles.userTextContainer}>
                ...
                <p className={navbarStyles.userEmail}>
                  {user?.email || "user@expensetarcker.com"}
                </p>
              </div>
