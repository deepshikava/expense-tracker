...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
  ...
  const { name: username = "User", email = "user@expensetarcker.com" } =
    user || {};
  const initial = username.charAt(0).toUpperCase();

  //to check for overflow in mobile menu
  useEffect(() => {
  ...
  //if clicked outside of sidebar, it gets collapsed
  useEffect(() => {
