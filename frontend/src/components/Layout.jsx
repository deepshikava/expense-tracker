...
const Layout = ({ onLogout, user, setUser }) => {
  ...
  //To edit/update a transaction - either income or expense
  ...
  //To delete a transaction - either income or expense
  ...
  //get stats according to the time
  const stats = useMemo(() => {
    const now = new Date();
  ...
  //Display 4 transactions and displays rest of the transaction over toggle button
